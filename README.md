...
### 배운점
- 개발을 잘하기 위해서는 하나의 서비스를 만들기까지의 시작과 끝의 경험이 필요하다고 생각해 "잊지말자 출첵" 프로젝트를 시작했습니다.
<br>앱 기획 / 디자인 경험 및 동료 개발자와 협업하여 앱 개발 경험을 가졌습니다. 
- 끊임없이 커뮤니케이션하고 서로에게 배우고 공유하며 문제를 해결하는 경험을 쌓았고 자기주도적인 학습 능력을 가졌습니다.
...
- S0rrow(Developer): Back-end
  - [안드로이드 스튜디오에서 셀레니움으로 크롤링 🕸](https://github.com/0sunzero0/RE_Crawler)
